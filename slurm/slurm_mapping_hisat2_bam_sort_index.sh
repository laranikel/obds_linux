...
hisat2 --threads 8 \
 ...
 --rna-strandness RF \
 --summary-file /project/exet5457/2_rnaseq/3_analysis/2_Mapping/stats2.txt \
 -S /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe.sam \
 | samtools view \
  -@ 8 \
  -sbh > /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-peV2.bam


# Will need sorted bam file for output analyses. Use -@ to set to multiple threads  to run faster
samtools sort -@ 8 /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-peV2.bam >  /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe_sortedV2.bam

samtools index -@ 8 /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe_sortedV2.bam
