...
samtools idxstats /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe_sorted.bam > /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe_sorted.idxstats

samtools flagstat /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe_sorted.bam > /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe_sorted.flagstat
