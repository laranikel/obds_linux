...
samtools view \
  -@ 8 \
  -b /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe.sam \
  > /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe.bam


# Will need sorted bam file for output analyses. Use -@ to set to multiple threads  to run faster
samtools sort -@ 8 /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe.bam >  /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe_sorted.bam

samtools index -@ 8 /project/exet5457/2_rnaseq/3_analysis/2_Mapping/aln-pe_sorted.bam
