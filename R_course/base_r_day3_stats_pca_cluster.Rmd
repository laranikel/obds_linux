...
iris_features <- head(iris_features)
```
...
```{r}
plot(pca_iris$x[ ,1], pca_iris$x[ , 2], xlab = "PC1", ylab = "PC2", col = iris$Species)
```
...
explained_variance <- c(pca_iris$sdev^2)
...
```{r}
barplot(explained_variance_ratio, ylim = 0:1, axes = TRUE, xlab = "PCs", ylab = "Variance explained")
...
```{r}
barplot(summary(pca_iris)$importance["Proportion of Variance", ])
#barplot(summary(pca_iris)$importance["Proportion of Variance" ,])

barplot(summary(pca_iris)$importance[2 ,], ylim = 0:1)
```
...
```{r}
dist_iris <- dist(iris_features, method = "euclidian")
...
```{r}
plot(pca_iris$x[ ,1], pca_iris$x[ , 2], xlab = "PC1", ylab = "PC2", col = iris_hclust_ward_labels)
```
...
par(mfrow = c(2, 2))
plot(pca_iris$x[ ,1], pca_iris$x[ , 2], main = "ward.D2", xlab = "PC1", ylab = "PC2", col = iris_hclust_ward_labels)
plot(pca_iris$x[ ,1], pca_iris$x[ , 2], main = "complete", xlab = "PC1", ylab = "PC2", col = iris_hclust_complete_labels)
plot(pca_iris$x[ ,1], pca_iris$x[ , 2], main = "average", xlab = "PC1", ylab = "PC2", col = iris_hclust_average_labels)
plot(pca_iris$x[ ,1], pca_iris$x[ , 2], main = "single", xlab = "PC1", ylab = "PC2", col = iris_hclust_single_labels+3)
par(mfrow = c(1, 1))
```
