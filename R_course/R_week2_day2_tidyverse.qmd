...
iris_raw %>% 
  ...
  slice_head(n=5) # or slice_max(sepal_area, n=5)
...
plot_iris <- ggplot(iris_for_ggplot, aes(x= sepal_area, fill = species)) + geom_histogram()
...
```{r}
plot_iris <- ggplot(iris_for_ggplot, aes(x= sepal_area, fill = species)) + 
